    ...
    textArray.forEach(function(currentText) {
      if (currentText) {
        var messageJson = {
          // <div class='segments'>
          'tagName': 'div',
          'classNames': [(isUser ? '.chat_usuario' : '.chatavatar')],
          'children': [{
        ...
        //imagen hacia arriba
                'tagName': 'img',
                'classNames': ['flechaArriba'],
                'attributes': [{
                 'name': 'src',
                 'value': (isUser ? '' : 'img/Flecha.svg'),
                 }, {

                'name': 'style',
                'value': isUser ? 'display:none ' :  'display: block'
              ...
              'children': [{
                ...
                //imagen hacia abajo
                'tagName': 'img',
                'classNames': ['flechaAbajo'],
                'attributes': [{
                 'name': 'src',
                 'value': (isUser ? 'img/FlechaAbajo.svg' : ''),
                 },{

                'name': 'style',
                'value': isUser ? 'display: block' :  'display: none'
